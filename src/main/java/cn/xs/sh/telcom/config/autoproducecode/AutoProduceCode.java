package cn.xs.sh.telcom.config.autoproducecode;
...
public class AutoProduceCode {
    ...
    private void test(){
        ...
        URL configUrl = ClassLoader.getSystemResource("generatorconfig/managementGeneratorConfig.xml");
//        URL configUrl = ClassLoader.getSystemResource("generatorconfig/xsGeneratorConfig.xml");
